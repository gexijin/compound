...
> **Revision B integrated** (on top of Revision A). New in B: title change; Keisha's background job, first-gen status, and civil-engineering major threaded through; the three-physics education spine (seed ch. 12, triptych ch. 17, hidden-category beat ch. 24); the concessionaire's offer moved to close ch. 13 and sit predatory-adjacent through ch. 14. Each chapter carries a **POV** line: how first-person, present-tense, no-hindsight Keisha is in the room for what the chapter shows.
...
Establish in one sentence, as pure texture: Keisha's fast-food job — weekday lunch shifts, never market days. *(This line silently answers "isn't she on shift?" for all 28 chapters; the job is weather, not plot — see "The job" in the money architecture.)* Also landing in narration this region, with punchlines and zero solemnity: she is the first Carter to enroll in college, and she studies civil engineering at SDSU — bridges, a fascination that is entirely hers. *(Metaphor ban in force from page one: no character ever uses "bridge" figuratively.)*
...
Keisha's wage-earner skepticism gets its voice here, in the deadpan register: the stand is "thirty dollars of someone else's money" — equity is pretend money to a girl who has only ever seen hours traded for dollars. She signs anyway, because operations is something she can *do*. *(Licensed ambient-skepticism line available here or nearby: Max — "college is the slowest-vesting bad investment I've ever seen." Per the map-less-neighborhood rule: never from family, never from the church ladies.)*
...
For Keisha the flop confirms the physics she already believes: a shift pays whether or not it rains; a stand can pay nothing. One dry line, then done.

**POV:** in-scene behind the stand for the full humiliation.
...
*(Craft note: the reveal needs a present-tense trigger, since the narrator has no hindsight. A classmate posts RA-training photos from Brookings; the memory arrives as recalled scene in Keisha's register, dated and done. The cash-box handover then happens live at the stand — trusted with money on the same day she remembers being refused a job.)*

**POV:** memory triggered by a post Keisha sees on the page; the handover is in-scene.
...
Denise's first almost-knowing moment: she reads the forwarded email a beat too long, thumb hovering on the date line, then puts the phone down and asks about supper. The chapter does not point at it. *(First of three; see chs. 11 and 18.)*
...
Estelle takes thirty percent in cash, at the stand, in front of the market. At least one vendor visibly finds this hilarious. The girls resent her because she did not haul ice. Estelle refuses to replace the cracked cooler handle.
...
**POV:** her own drafts folder, her own group chat.
...
**POV:** in-scene; the chapter's event is inside her own noticing.
...
Keisha pays a real deposit she cannot afford to keep the lie alive. Name the deposit's source on the page — her savings plus accumulated wages, scraped to zero. The deposit must visibly empty her, because ch. 16's float is its direct consequence, not a separate sin. The bedding bag enters her room.
...
The seed for ch. 17, planted in passing: somewhere in Emily's figures, the stand has quietly started out-earning Keisha's fryer per hour. Keisha hears it, files it, and does not let it mean anything yet. *(See "The three physics of money" in the bible.)*
...
Sofi invoices the recipe. Lourdes is appalled — and the mother-daughter scene is about love's terms, not banks: in this family you do not bill the people you love, and Sofi is billing a stand her neighbors-who-are-family run. Staged at the Carters' kitchen table, because that is where the amendment is being drafted when Lourdes comes to walk Sofi home; the argument plays out in front of the neighbors-who-are-family, which is the argument's whole subject — the audience *is* the scene.

The girls confront Estelle. Estelle admits the original deal was not fair — she, of all people, wrote an erasing deal. The agreement is amended: Sofi gets a per-batch recipe royalty and a vote, on paper, with a number. Estelle signs last.

One beat, played dry: Sofi is sixteen; the amendment needs a guardian's signature. Lourdes, mid-objection, is handed the pen. She reads every line first. She has the receipts for why.

**Closing hook (moved forward from ch. 15):** the concessionaire — the food-truck owner the girls have liked all summer — stops by as the table clears and offers **$600 for the booth and "brand."** Friendly as ever. Minutes-old ink on the fairness amendment; nobody yet knows that paper is a poison pill. The offer is not answered. It just sits there.
...
The offer gets its meeting. The insult is felt first and fully — the concessionaire liked them all summer and still priced three girls' work at scrap value; let the girls say so, to each other, before any math. Keisha secretly wants to take it, and her motive is double-loaded: escape from visibility (the stand is where the church ladies count her weeks) *and* wage-brain ($600 cash is real in a way equity has never been to her — see her cast entry). Emily's math says keep it. Then Sofi asks whether the recipe transfers. It does not; the amended agreement says it is hers, and the offer visibly deflates — the "brand" was mostly the drink. Vote: 3–1 against selling.
...
Short after the deposit — the deposit emptied her; the float is what empty does next. Her current paycheck is already spoken for, the next one is nine days out, and the ice supplier must be paid today. Keisha borrows $60 from the stand float, meaning to replace it. She calls it internal bridge financing. *(The timing armor is canonical — see the cover-up escalation list: steady paychecks must never make this look like cash-flow management. This is a line crossed by a girl at zero.)*
...
**The triptych.** Emily lays three columns on one table — the book's education spine made visible (see "The three physics of money"): Keisha's per-hour at the register, per-hour at the stand, and Max's screenshot. Nobody lectures; the columns just sit there, and each person at the table reads a different sermon in them. Keisha's whole money physics — hours-for-dollars as the only lever — takes its first structural crack, the same week the fastest column is peaking.

The same evening, Sydney corners her. She loves both of them and sees the cliff, and she says so plainly — which from the loudest spender in the book lands like a fire alarm in a church. Temptation and warning in one chapter, so neither gets a full night's sleep between them.
...
A storm cancels a Levitt Friday. The crowd never forms, the night's stock melts, and the venue Sydney found proves it can vanish — her discovery shows its downside the same week she played the adult. The stand makes nothing. For Keisha, quiet confirmation of the oldest physics: her shift would have paid tonight.

Max stays for teardown in the rain. Unneeded, again — but this time Keisha doesn't keep the count. No portfolio talk, no green screenshots; just two people hauling coolers through weather, and one exchange that is about nothing and therefore about everything. **This is the slow burn's single genuine beat.** It must contain zero money and zero irony, which is why it can only exist in a chapter where the money already lost.

Home, soaked: Denise is up. The bedding bag sits on the chair where it has sat for weeks, and Denise looks at it one beat too long before saying goodnight — her third almost-knowing moment, completing the set (chs. 6, 11, 18). The chapter does not point at it.
...
**POV:** her own thumb, her own screen, her own sent folder.
...
**POV:** her confession, delivered in-scene to the girls.
**Turn:** the small confession rehearses the big one.

### 22. The Crash

Max's fall happens on the page, in three movements Keisha is present for:

1. **The screenshot** lands in the group chat — the one that cannot be cropped clean — on Keisha's own phone, in red, timestamped.
2. **The call.** Sydney summons Keisha to the Ellis kitchen (Sydney's instinct when things break is witnesses she trusts). Max makes the quiet call about getting the warehouse job back from the next room; Keisha hears the half of it that matters — the *yes sir*, the *whenever there's a shift*.
3. **The boring account.** At the next teardown, in front of everyone, Max asks Emily how to open it. Public, because his performance was public; the type-accurate self-awareness holds — he knows the apology has to run on the same channel the bragging did.

His crash remains his own: no reforming for Keisha, no scene where she saves him.
...
Keisha's accusation is not simply, "You knew and let me panic." It is sharper:

> "You built an entire system of secret help so you would never have to have one honest conversation."

And it names the ch. 14 asymmetry: *you told me what they did to you, and still not what you did about it.* The secret help was hidden inside an apparent moment of openness. *(Alternate, decidable at draft: keep Keisha's line verbatim as above and let Estelle's defense be what names the asymmetry.)*

The 529 is love engineered to avoid intimacy. Estelle hid the 529 from Denise too, because explaining it would reveal the larger fortune. One secret required another. That makes Denise's ch. 27 admission hurt more: someone could have taught her and chose envelopes instead.

Mid-tirade, Keisha hears herself — **this remains the scene's center; everything else in the chapter serves it.** She has hidden $2,800 for four months. Estelle hid a portfolio — and a whole self — for fifty years. Same wound, different scale.

Estelle's defense comes in two layers, and the second is the one she has never said aloud:
...
**The reciprocity beat.** After that line, a silence — and then Keisha says the number. Out loud, to Estelle, for the first time to anyone: *twenty-eight hundred dollars.* Not a request; a matching disclosure. Estelle gave 1976; Keisha gives $2,800. Estelle does not offer to pay it, and the chapter must let that refusal stand without cruelty — she has just explained why help-as-money is the pattern, not the repair. This beat is load-bearing: it arms the ch. 26 loan (Estelle now knows the situation), and it converts ch. 27 from first confession to second, harder telling — family stakes instead of first-utterance stakes.
...
The staging is POV-safe *by Sydney's own design*: she performs money — always has — and her last performance of the summer is an honest one, called like a show. The card paydown is shown, not narrated: she passes the phone around with the balance on it, because for Sydney a number nobody sees doesn't count.
...
Estelle pays full price for one beautiful or necessary thing. Then comes the laptop loan — her program needs CAD software; the machine is a tool, not a treat: real terms, token interest, negotiated by Keisha, signed by both — the first time Estelle teaches money out loud, and it costs her something.
...
Keisha and Max have a post-crash conversation. They split the cost of a date — earned by ch. 18's rain, arriving as a continuation instead of a swerve.
...
And a third beat, quiet, mirrors it back: Keisha tells her mother about the portal day — *I knew you were bluffing; I let you, because I was bluffing too.* Two covers dismantled in one confession.

**The disclosure protocol:** when the closing math reaches the 529 line, Keisha stops. It is not hers to explain, and she has learned exactly enough this summer to know it. She looks at Estelle. **Estelle names the fortune and the 529 herself** — the second time in her life she teaches money out loud, and harder than the first, because the first was terms across a table and this is fifty years across a kitchen.
...
The gap closes on the page: 529 slice, circulation-desk job, stand share, tiny margin. The bedding comes out of the bag.
